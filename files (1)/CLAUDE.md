...
React Native app built with Expo (SDK 54, expo-router, TypeScript). A habit/routine tracker built on an explicitly non-punitive, evidence-cited approach. Russian-language UI. Android-first, distributed via RuStore; iOS comes later.
...
src/
  ...
  domain/
    scoring.ts              18 answers → six values
...
| `docs/onboarding-brief.md` | 22 screens, 18 questions, scoring formulas |
